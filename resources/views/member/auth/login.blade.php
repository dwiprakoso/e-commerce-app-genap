        ...
        <div class="px-8 pb-8">
            ...
            <div class="space-y-3 mb-6">
                <a href="{{ route('member.social.redirect', 'google') }}"
                    ...
                    <span class="text-gray-700 font-medium group-hover:text-gray-900">Masuk dengan Google</span>
                </a>
                ...
                <a href="{{ route('member.social.redirect', 'facebook') }}"
                    ...
                    <span class="font-medium">Masuk dengan Facebook</span>
                </a>
            </div>
            ...
            <form method="POST" action="{{ route('member.login.post') }}" class="space-y-6">
                @csrf
